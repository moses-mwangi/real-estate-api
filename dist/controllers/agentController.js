...
exports.getAgent = exports.getAgents = void 0;
...
exports.getAgent = (0, catchAsync_1.default)(async (req, res) => {
    const agent = await agentModel_1.default.findById(req.params.id);
    res.status(200).json({
        status: "succefully",
        agent,
    });
